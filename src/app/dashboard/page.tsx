...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // Detect login method
    if (user) {
      // Check if user has oauth fields - indicates Google login
      const isOAuthUser = localStorage.getItem('accessToken') || window.location.search.includes('accessToken');
      setLoginMethod(isOAuthUser ? 'Google OAuth' : 'Email & Password');
    }
  }, [user]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              {loginMethod && (
                <p className="text-sm text-blue-600 dark:text-blue-400">Logged in via: {loginMethod}</p>
              )}
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                  <p>You have successfully logged into your account. Welcome to your dashboard!</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
                <div className="text-sm">
                  {user?.isPhoneVerified ? (
                    <span className="text-green-600 dark:text-green-400">✓ Phone verified</span>
                  ) : (
                    <span className="text-yellow-600 dark:text-yellow-400">⚠ Phone not verified</span>
                  )}
                </div>
              </div>
            </div>
